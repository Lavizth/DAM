...
public class E8_Principal2 {
    public static void main(String[] args) throws IOException {

        System.out.println("La cadena está en el fichero Datos.txt");

        File directorio = new File(".\\out\\production\\Ejercicio8\\Ejercicios\\Ejercicio8");
        ProcessBuilder pb = new ProcessBuilder("java", "E8_subproceso");
